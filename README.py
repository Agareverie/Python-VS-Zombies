...
class Seed: def init(self): self.recharge = 0 self.recharge_index = 2
...
def check_status(self):
    if self.recharge != self.recharge_index:
        ...
        return "Active"
class Sunflower(Seed): def init(self): self.recharge = 2 self.recharge_index = 2 self.sun_cost = 50 self.look = "S"

class Peashooter(Seed): def init(self): self.recharge = 0 self.recharge_index = 3 self.sun_cost = 100 self.look = "P"

class Wallnut(Seed): def init(self): self.recharge = 0 self.recharge_index = 4 self.sun_cost = 50 self.look = "W"

class Lane: def init(self, name): self.name = name self.lane = ['M', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '] self.mower_index = 1
...
def use_mower(self):
    if self.mower_index == 1:
        ...
        if self.lane[0] == "Z":
            game.check_loss = 1
class Game: def init(self): self.check_loss = 0 self.sun_count = 50 self.plant_this_turn = 2 self.lawn = [Lane(1), Lane(2), Lane(3), Lane(4), Lane(5)] self.seeds = [Sunflower(), Peashooter(), Wallnut()]
